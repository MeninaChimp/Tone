 ...
 */
.directive('tab', ['$parse', '$timeout', '$log', function($parse, $timeout, $log) {
  return {
    require: '^tabset',
    restrict: 'EA',
    replace: true,
    ...
    link: function(scope, elm, attrs, tabsetCtrl, transclude) {
      ...
      scope.select = function() {
        if ( !scope.disabled ) {
          window.tabsetTimeId && $timeout.cancel(window.tabsetTimeId);
          window.tabsetTimeId = $timeout(function(){
          	scope.active = true;
          }, 100);
        }
      };
...
angular.module("template/tabs/tab.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/tabs/tab.html",
    "<li ng-class=\"{active: active, disabled: disabled}\" ng-click=\"select()\" ng-mouseenter=\"select()\" ng-mouseleave=\"deselect()\" tab-heading-transclude>{{heading}}\n" +
    "</li>\n" +
    "");
}]);
